        ...
        <TabsContent value="appearance" className="space-y-4">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-5 gap-2">
                  <div className="h-10 rounded-md bg-blue-600 cursor-pointer ring-2 ring-offset-2 ring-blue-600"></div>
                  <div className="h-10 rounded-md bg-green-600 cursor-pointer"></div>
                  ...
                  <div className="h-10 rounded-md bg-gray-600 cursor-pointer"></div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="showMinimap">Show Sidebar Mini-map</Label>
                  <div className="text-sm text-muted-foreground">
                    Display navigation overview in sidebar
                  </div>
                </div>
                <Switch id="showMinimap" />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
